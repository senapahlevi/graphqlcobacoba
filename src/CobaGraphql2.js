...
import Character from "./charactergraphql2";
import Head from "next/head";
function CobaGraphql2(results) {
  ...
  return (
    <Flex direction="column" justify="center" align="center">
      ...
      <footer>Powered by Energy Drinks 🥫 and YouTube Subscribers.</footer>
    </Flex>
  );
}

export default CobaGraphql2;
